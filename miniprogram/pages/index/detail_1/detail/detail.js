...
Page({
  ...
  gotosign() {
    if (app.userInfo._id) {
      wx.navigateTo({
        url: '/pages/index/league/signup/signup?shetuanid=' + this.data.shetuanid + '&name=' + this.data.societyname + '&title=' + this.data.activecontent + '&photo=' + this.data.photoid
      })
    }
    else {
      wx.showToast({
